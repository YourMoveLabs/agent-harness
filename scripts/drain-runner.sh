...
for wf in agent-engineer.yml agent-ops-engineer.yml agent-reviewer.yml agent-product-owner.yml agent-scans.yml agent-user-experience.yml agent-strategic.yml agent-triage.yml agent-site-reliability.yml agent-content-creator.yml agent-product-analyst.yml agent-qa-analyst.yml agent-financial-analyst.yml agent-customer-ops.yml agent-marketing-strategist.yml agent-escalation-lead.yml agent-human-ops.yml; do
